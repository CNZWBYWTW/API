window.onload = function () {
    ...
    function setbilivideourl() {
        if (bili_bv_list_m < bili_bv_list.length) {
            ...
            fetch(`https://www.bili-video-api.cnzw.us.kg/?bv=${bili_bv_list[bili_bv_list_m].getAttribute('data-bili-bv')}&p=${bili_bv_list[bili_bv_list_m].getAttribute('data-bili-p')}&otype=json&q=80`)
